...
Porto, Portugal | +351 916769173 | vitor.babo@outlook.com

LinkedIn: linkedin.com/in/vitorpbabo
...
- **Scalable Infrastructure:** Provisioned secure resources across **AWS** and **Azure** using **Terraform**; implemented automated **CI/CD pipelines** via GitHub Actions.

- **Technical Leadership:** Established organization-wide **MLOps standards** adopted by the IT department, reducing tech stack variability.


**Continental Engineering Services | Software Engineer**
_September 2022 – October 2024_

- **IoT System Development:** Developed a core IoT application integrating **MQTT/REST protocols** and **Azure IoT**, ensuring reliable OT-to-IT data bridging.

- **Data Engineering:** Built real-time services using **.NET and SQL Server** to standardize sensor data inputs from production machinery.

- **Legacy Modernization:** Refactored legacy PLC software into **containerized C#/.NET applications** for edge deployment, improving system maintainability.
